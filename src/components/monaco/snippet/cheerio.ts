const snippet = `
interface Document { }
declare namespace CheerioModule {
  ...
  function _load(html: string, options?: CheerioParserOptions): Root;
  function _load(element: Element | Element[], options?: CheerioParserOptions): Root;
  type load = typeof _load;
